"""Deprecated MVP workflow helpers.

This module contains legacy helpers that used to live in mvp_workflow. They
remain available for compatibility and testing, but orchestration now lives in
execute_task only.
"""
