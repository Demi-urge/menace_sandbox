...
"""Compatibility shim for :mod:`sandbox_settings`."""

from importlib import import_module

_IMPL_MODULE_NAME = f"{__package__}.sandbox_settings_impl" if __package__ else "menace.sandbox_settings_impl"
...
def _resolve_source_module():
    try:
        ...
        if (exc.name or "") != _IMPL_MODULE_NAME:
            raise
        return import_module("sandbox_settings")
