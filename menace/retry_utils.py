...
"""Compatibility shim for :mod:`retry_utils`."""

from importlib import import_module

_IMPL_MODULE_NAME = f"{__package__}.retry_utils_impl" if __package__ else "menace.retry_utils_impl"
...
def _resolve_source_module():
    try:
        ...
        if (exc.name or "") != _IMPL_MODULE_NAME:
            raise
        return import_module("retry_utils")
