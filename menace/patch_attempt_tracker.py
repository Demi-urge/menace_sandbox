...
"""Compatibility shim for :mod:`patch_attempt_tracker`."""

from importlib import import_module

_IMPL_MODULE_NAME = f"{__package__}.patch_attempt_tracker_impl" if __package__ else "menace.patch_attempt_tracker_impl"
...
def _resolve_source_module():
    try:
        ...
        if (exc.name or "") != _IMPL_MODULE_NAME:
            raise
        return import_module("patch_attempt_tracker")
