...
"""Compatibility shim for :mod:`db_router`."""

from importlib import import_module

_IMPL_MODULE_NAME = f"{__package__}.db_router_impl" if __package__ else "menace.db_router_impl"
...
def _resolve_source_module():
    try:
        ...
        if (exc.name or "") != _IMPL_MODULE_NAME:
            raise
        return import_module("db_router")
