...
"""Compatibility shim for :mod:`self_coding_engine`."""

from importlib import import_module

_IMPL_MODULE_NAME = f"{__package__}.self_coding_engine_impl" if __package__ else "menace.self_coding_engine_impl"
...
def _resolve_source_module():
    try:
        ...
        if (exc.name or "") != _IMPL_MODULE_NAME:
            raise
        return import_module("self_coding_engine")
