...
FUNCTION_IMPLEMENTATION_MAP: Dict[str, str] = {
    "click_target": "Use an automation library to click the given coordinates or selector and return None",
    "ocr_image": "Call vision_utils.detect_text on the image path or bytes and return the extracted text",
    "type_text": "Send keyboard input to the active field using an automation library",
    "capture_screenshot": "Save a screenshot to the provided path and return the path",
}
