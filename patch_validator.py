"""Deterministic, static patch validation helpers.

This module provides an isolated validate_patch entry point that performs
AST-only checks without executing code, importing dynamic modules, or
...
from menace_sandbox.stabilization.errors import MenaceRuleSchemaError, MenaceValidationError
...
def validate_patch(
    ...
    *,
    ...
    except Exception as exc:  # noqa: BLE001 - boundary validation error capture
        errors.append(
